        ...
        <ScrollView>
          <View style={[styles.card, styles.flx]}>
            ...
            >
              ...
              >
                <Image
                  source={{ uri: "https://dialerpstorage.blob.core.windows.net/10127/2936/59.jpg" }} // Replace "ProfilePicURL" with the key used for the profile picture URL
                  style={{
                    width: 100,
                    height: 100,
                    borderRadius: 50,
                ...
                <Text
                  style={[styles.prizetext1, styles.greytxt2, styles.fw500]}
                >
                 8851354099
                </Text>
              </View>
